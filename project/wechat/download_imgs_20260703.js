// download_imgs_20260703.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-我把家里的钟都调慢了五分钟', kws: ['客厅 挂钟 时钟', '家庭 客厅 沙发 温馨'] },
  { dir: '02-被裁后去前司楼下吃面遇到接我工位的人', kws: ['兰州拉面 面馆 一碗面', '写字楼 玻璃幕墙 阳光'] },
  { dir: '03-35岁我把微信好友从800删到80', kws: ['手机 微信 通讯录 屏幕', '手机 划屏幕 深夜 床上'] },
  { dir: '04-表妹填志愿那天全家围着一本厚书坐了三小时', kws: ['高考 志愿填报 指南 书', '家庭 客厅 围坐 讨论'] },
];
