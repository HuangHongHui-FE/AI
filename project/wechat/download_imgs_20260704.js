// download_imgs_20260704.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-我把结婚证锁进抽屉反而不想离了', kws: ['结婚证 红本 抽屉', '夫妻 家 沙发 背影'] },
  { dir: '02-00后实习生问我为什么要装忙', kws: ['办公室 加班 夜晚 工位', '写字楼 电脑 键盘'] },
  { dir: '03-我开始每天删一张照片', kws: ['手机 相册 划屏幕', '手机 备忘录 深夜'] },
  { dir: '04-40度那天公司空调坏了总监先脱了西装', kws: ['写字楼 玻璃幕 阳光', '办公室 西装 商务'] },
];
