// download_imgs_20260711.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-我在老公抽屉里翻到一张我没拍的照片', kws: ['抽屉 台灯 夜晚 书桌', '打印照片 旧照片 桌面'] },
  { dir: '02-我开始每天给老公留一盏灯', kws: ['玄关 小夜灯 夜晚 暖光', '小区 楼下 路灯 深夜'] },
  { dir: '03-公司让所有人签一份自愿放弃年假的承诺书', kws: ['办公室 加班 签字 文件', '办公桌 A4纸 笔 职场'] },
  { dir: '04-今年春节三天我收到一百一十二条群发拜年', kws: ['手机 微信 深夜 消息', '手机 屏幕黑 独坐 夜晚'] },
];
