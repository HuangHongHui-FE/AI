// download_imgs_20260705.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-我和老陈约定每周三晚上不说话第三周他先开口了', kws: ['客厅 沙发 夜晚 两个人', '家庭 餐桌 台灯 温馨'] },
  { dir: '02-老公失业第二个月我开始每天给他留一张便利贴', kws: ['便利贴 黄色 纸条 贴', '剃须刀 卫生间 镜子'] },
  { dir: '03-公司取消免费晚餐那周加班的人突然少了一半', kws: ['办公室 加班 夜晚 工位', '写字楼 电梯 夜晚'] },
  { dir: '04-我开始每天早到公司十分钟只为在车里坐一会', kws: ['地下车库 汽车 车内', '汽车 驾驶座 夜晚 独处'] },
];
