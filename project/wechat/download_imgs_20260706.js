// download_imgs_20260706.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-老公学会网购后给我买了三件一模一样的裙子', kws: ['快递袋 玄关 拆包裹', '衣柜 连衣裙 女性'] },
  { dir: '02-婆婆来住三个月走那天给我留了一坛咸菜', kws: ['阳台 咸菜 坛子 腌菜', '客厅 婆婆 老人 背影'] },
  { dir: '03-公司让我们写五年规划我交了一张白纸', kws: ['办公桌 电脑 空白纸', '办公室 加班 夜晚 工位'] },
  { dir: '04-我在医院走廊和一个保安聊了两个小时', kws: ['医院 走廊 夜晚 长椅', '医院 走廊 白灯 地面'] },
];
