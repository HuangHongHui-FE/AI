// download_imgs_20260709.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-老公开始每天问我今天累不累我反而想逃', kws: ['厨房 切菜 暖光 夜晚', '夫妻 客厅 沙发 沉默'] },
  { dir: '02-新来的实习生叫我姐我愣了三秒', kws: ['办公桌 电脑 工位 职场', '镜子 卫生间 女性凝视'] },
  { dir: '03-我把老公的微信备注从老公改回了他的全名', kws: ['手机 微信 通讯录 夜晚', '沙发 两人 看电视 温暖'] },
  { dir: '04-我把衣柜里十年没穿的衣服全送了人', kws: ['衣柜 衣服 整理 女生', '旧衣服 捐赠 袋子 楼道'] },
];
