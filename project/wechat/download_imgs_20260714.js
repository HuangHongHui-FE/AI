// download_imgs_20260714.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-老公开始每天给我发他中午吃的饭', kws: ['手机 饭菜 午餐 拍照', '食堂 排骨汤 烟火气', '厨房 小米粥 锅 温暖'] },
  { dir: '02-老公开始替我回我妈的微信', kws: ['客厅 沙发 手机 微信 夜', '厨房 切土豆 男人', '手机 屏幕 安静 深夜'] },
  { dir: '03-公司让我带教一个比我大十岁的下属', kws: ['办公室 会议室 白板 职场', '办公桌 电脑 中年 男人', '写字楼 窗外 城市夜景'] },
  { dir: '04-我把手机通知全关掉的那一周', kws: ['手机 静置 屏幕 黑屏', '沙发 一个人 发呆 安静', '书架 台灯 书 居家'] },
];
