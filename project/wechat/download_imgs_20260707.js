// download_imgs_20260707.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-我和老公分房睡半年昨晚他把枕头搬回了主卧', kws: ['卧室 床 枕头 夜晚', '床头台灯 卧室 温暖'] },
  { dir: '02-我在老公旧手机里翻到一个备注叫老地方的号码', kws: ['街角 修鞋摊 老人 雨棚', '旧手机 通讯录 屏幕 特写'] },
  { dir: '03-新来的总监第一天把我工位上那盆绿萝搬走了', kws: ['办公桌 绿萝 盆栽 工位', '办公桌 电脑 空旷 夜晚'] },
  { dir: '04-四十岁生日那天我数了数能拨出去的电话只有三个', kws: ['出租屋 阳台 夜晚 路灯', '一碗面 独居 简单 暖光'] },
];
