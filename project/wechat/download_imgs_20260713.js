// download_imgs_20260713.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-结婚第十二年我们第一次一起逛菜市场', kws: ['菜市场 蔬菜 摊位 烟火气', '夫妻 逛菜市场 生活', '黄昏 菜市场 灯笼 人'] },
  { dir: '02-我跟老公约法三章吵架必须当面吵', kws: ['客厅 沙发 夫妻 对坐', '两个人 喝茶 谈话 居家', '夜晚 厨房 夫妻 背影'] },
  { dir: '03-领导让我把项目让给新人我没让', kws: ['办公室 会议室 白板', '办公桌 电脑 职场 加班', '写字楼 窗外 城市夜景'] },
  { dir: '04-我决定以后微信只回一次', kws: ['手机 微信 消息 屏幕静', '一个人 沙发 看手机 安静', '书桌 台灯 笔记本 居家'] },
];
