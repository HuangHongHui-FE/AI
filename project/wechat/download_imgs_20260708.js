// download_imgs_20260708.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-我和老公约定吵架不过夜第三十七天他抱被子去了沙发', kws: ['卧室 沙发 被子 夜晚', '客厅 沙发 深夜 孤灯'] },
  { dir: '02-老公在饭桌上说我们这日子是过给谁看的', kws: ['饭桌 晚饭 家常菜', '阳台 抽烟 夜晚 城市'] },
  { dir: '03-前同事寄来一个U盘里面是我五年前删掉的辞职信', kws: ['办公桌 电脑 文件 夜晚', '办公室 加班 工位 背影'] },
  { dir: '04-我把家里所有镜子都用布盖上了', kws: ['卫生间 镜子 布料 蒙住', '梳妆台 镜子 浴巾'] },
];
