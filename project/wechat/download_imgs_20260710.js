// download_imgs_20260710.js — skill06 方案0：搜狗搜图 + URL去重 + 自动挑选(大文件优先+源多样)
...
const arts = [
  { dir: '01-老公开始记账后我才发现这十年我花了多少', kws: ['手机 记账 厨房 暖光', '夫妻 沙发 对账 单据'] },
  { dir: '02-公司让大家匿名互评我收到了三条', kws: ['办公桌 电脑 职场 思考', '会议室 评价 表格 文档'] },
  { dir: '03-我决定不再跟老公解释我为什么哭', kws: ['沙发 客厅 夜晚 杯子 水', '女性 窗边 思绪 安静'] },
  { dir: '04-我把手机屏幕调成黑白用了一周', kws: ['手机 屏幕 黑白 桌面', '手机 灰色 手持 夜晚'] },
];
